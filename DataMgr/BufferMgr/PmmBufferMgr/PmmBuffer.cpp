...
void
mymemcpy(char *dest, const char *src, const size_t len)
{
...
PmmBuffer::PmmBuffer(BufferMgr* bm,
...
void PmmBuffer::readData(int8_t* const dst,
                         const size_t numBytes,
                         const size_t offset,
...
void PmmBuffer::writeData(int8_t* const src,
                          const size_t numBytes,
                          const size_t offset,
