...
class AbstractBufferMgr {
 public:
  ...
  // Chunk API
  virtual AbstractBuffer* createBuffer(const MemoryLevel memLevel, const ChunkKey& key,
  ...
  virtual AbstractBuffer* getBuffer(const MemoryLevel memLevel, const ChunkKey& key, const size_t numBytes = 0) = 0;
  virtual void fetchBuffer(const MemoryLevel memLevel, const ChunkKey& key,
                           AbstractBuffer* destBuffer,
                           const size_t numBytes = 0) = 0;
  // virtual AbstractBuffer* putBuffer(const ChunkKey &key, AbstractBuffer *srcBuffer,
  // const size_t numBytes = 0) = 0;
  virtual AbstractBuffer* putBuffer(const MemoryLevel memLevel, const ChunkKey& key,
  ...
  // Buffer API
  virtual AbstractBuffer* alloc(const MemoryLevel memLevel, const size_t numBytes = 0) = 0;
