...
void GpuCudaBufferMgr::addSlab(const MemoryLevel memLevel, const size_t slabSize) {
...
void GpuCudaBufferMgr::allocateBuffer(const MemoryLevel memLevel, BufferList::iterator segIt,
                                      const size_t pageSize,
