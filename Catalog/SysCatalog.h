...
class SysCatalog : private CommonFileOperations {
 public:
  ...
  void storeDataMgrStatistics(std::map<std::vector<int>, size_t> &columnFetchStats, std::map<std::vector<int>, size_t> &columnChunkStats, std::map<std::vector<int>, size_t> &columnFetchDataSizeStats);
